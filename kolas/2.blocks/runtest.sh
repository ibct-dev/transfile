...
docker run -it -d --name led --net=host ibct/ledgis-test:2.0.7 nodeos -d ~/eos.data/producer_node --config-dir ~/eos.data/producer_node -l ~/eos.data/logging.json --http-server-address 0.0.0.0:8888 -p led -e
